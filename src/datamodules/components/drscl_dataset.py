...
def preprocess_batch_for_hf_dataset(dataset, tokenizer, args):
    ...
    for i in range(batch_size):
        ...
        label  = dataset[i]['identifier'][args.identifier_type]
        
        text   = process_text(prefix, text)
        ...
        if positive_len > 0:
            ...
            pos_prefix = dataset[i]['positive_ctxs'][pos_index]['prefix']
            pos_label  = dataset[i]['positive_ctxs'][pos_index]['identifier'][args.identifier_type]
            pos_text   = process_text(pos_prefix, pos_text)
